...
import com.huddey.core.userman.data.entity.SocialConnection;
...
public class OAuthUtils {
  ...
  public static void addSocialConnection(
    ...
    socialConnection.setAuthProvider(authProvider);
    socialConnection.setProviderUserId(String.valueOf(user.getId()));
    socialConnection.setProviderEmail(user.getEmail());
    socialConnection.setAccessToken(oAuth2UserRequest.getAccessToken().getTokenValue());
