...
public class StripeSetupService {
  ...
  public void createHuddeyProducts() throws StripeException {
    ...
    createPrice(starterProduct.getId(), 15300L, YEAR, "Starter Yearly");
    ...
    createPrice(proProduct.getId(), 3900L, MONTH, "Pro Monthly");
    createPrice(proProduct.getId(), 37400L, YEAR, "Pro Yearly");
    ...
    createPrice(eliteProduct.getId(), 9900L, MONTH, "Elite Monthly");
    createPrice(eliteProduct.getId(), 89100L, YEAR, "Elite Yearly");
    ...
    createPrice(teamsProduct10Seats.getId(), 253900L, YEAR, "Teams Yearly for 10 seats");
    ...
    createPrice(teamsProduct20Seats.getId(), 437500L, YEAR, "Teams Yearly for 20 seats");
    ...
    createPrice(teamsProduct30Seats.getId(), 610900L, YEAR, "Teams Yearly for 30 seats");
    ...
    createPrice(teamsProduct50Seats.getId(), 916900L, YEAR, "Teams Yearly for 50 seats");
    ...
    createPrice(teamsProProduct10Seats.getId(), 423300L, YEAR, "Teams Yearly for 10 seats");
    ...
    createPrice(teamsProProduct20Seats.getId(), 642400L, YEAR, "Teams Yearly for 20 seats");
    ...
    createPrice(teamsProProduct30Seats.getId(), 841600L, YEAR, "Teams Yearly for 30 seats");
    ...
    createPrice(teamsProProduct50Seats.getId(), 1180200L, YEAR, "Teams Yearly for 50 seats");
  }
