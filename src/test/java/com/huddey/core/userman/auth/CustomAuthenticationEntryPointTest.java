...
class CustomAuthenticationEntryPointTest {
    ...
    void commence_BasicUnauthorizedAccess_ShouldReturnProperResponse() throws Exception {
        ...
        verify(objectMapper).writeValue(any(ServletOutputStream.class), argThat(body -> {
            Map<String, Object> map = (Map<String, Object>) body;
            return map.get(CustomAuthenticationEntryPoint.STATUS).equals(HttpServletResponse.SC_UNAUTHORIZED)
    ...
    void commence_OAuth2AuthenticationFailure_ShouldReturnOAuth2ErrorDetails() throws Exception {
        ...
        OAuth2Error oauth2Error = new OAuth2Error(
            ...
            "https://oauth2.example.com/errors"
        );
        ...
        verify(objectMapper).writeValue(any(ServletOutputStream.class), argThat(body -> {
            ...
            return map.get("error_code").equals("invalid_token")
                && map.get(CustomAuthenticationEntryPoint.MESSAGE).equals("The token has expired")
